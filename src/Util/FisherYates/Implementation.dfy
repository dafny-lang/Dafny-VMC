...
module FisherYates.Implementation {
  ...
  trait {:termination false} Trait32 extends Interface.Trait32 {

    method {:vcs_split_on_every_assert} Shuffle32<T>(a: array<T>)
      decreases *
      modifies `s, a
    ...
    method Swap32<T>(a: array<T>, i: nat32, j: nat32)
      modifies a
      requires i <= j
