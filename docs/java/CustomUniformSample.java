...
public class CustomUniformSample implements Uniform.Interface.TraitMinus {
    static ThreadLocal<SecureRandom> rng;

    public CustomUniformSample() {
        CustomUniformSample.rng = ThreadLocal.withInitial(CustomUniformSample::createSecureRandom);
    }
